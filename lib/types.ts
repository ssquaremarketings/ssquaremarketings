...
export interface Project {
  ...
  // --- Project type ---
  type: 'houses' | 'house-plot' | 'apartments' | 'agriculture-land' | 'commercial-space' | 'open-plots' | 'our-ventures'
}
// Project type constants
export const PROJECT_TYPES = [
  { value: 'houses',            label: 'Houses',             icon: '🏠', color: 'bg-orange-100 text-orange-800' },
  { value: 'house-plot',        label: 'House/Plot',         icon: '🏡', color: 'bg-amber-100 text-amber-800' },
